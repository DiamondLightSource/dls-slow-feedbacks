...
class VefbServer(object):
    ...
    def records(self):
        ...
        self.status_pv = builder.mbbOut(
            ...
            ("Ring mode changed during vefb", "MAJOR"),
            ("Skew Quads delta error", "MAJOR"),
            ("Bad emittance value", "MINOR"),
            ("Missing calc parameters", "MAJOR"),
            ("Skew Quads read/write error", "MAJOR"),
            ("Recovering cameras", "MINOR"),
            ("No emittance value", "MINOR"),
            ("Persistent emittance error", "MAJOR"),
            ("Having no effect", "MAJOR"),
            ("Away from target", "MAJOR"),
            ("Method changed during vefb", "MAJOR"),
        ...
        self.calc_status_pv = builder.mbbOut(
            ...
            ("Ring mode changed during vefb", "MINOR"),
            ("Skew Quads delta error", "MINOR"),
            ("Bad emittance value", "MINOR"),
            ("Missing calc parameters", "MINOR"),
            ("Skew Quads read/write error", "MINOR"),
            ("Recovering cameras", "MINOR"),
            ("No emittance value", "MINOR"),
            ("Persistent emittance error", "MINOR"),
            ("Away from target", "MINOR"),
            ("Method changed during vefb", "MINOR"),
            initial_value=VefbStatus.OK,
        )
