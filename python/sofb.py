...
class Sofb(object):
    ...
    def correction(self):
        ...
        all_enabled_bpms = self.lattice.get_values(
            'BPM',
            'enabled',
            pytac.RB,
            dtype=np.bool_
        ...
        correctors_x_enabled = self.lattice.get_values(
            'HSTR',
            'h_sofb_disabled',
            pytac.RB,
            dtype=np.bool_
        ) == 0
        correctors_y_enabled = self.lattice.get_values(
            'VSTR',
            'v_sofb_disabled',
            pytac.RB,
            dtype=np.bool_
        ...
        BPMs_x_values = self.lattice.get_values(
            'BPM',
            'x',
            pytac.RB,
            dtype=np.float64
        )[bpms_x_enabled]
        correctors_x_values = self.lattice.get_values(
            'HSTR',
            'b0',
            pytac.RB,
            dtype=np.float64
        ...
        BPMs_y_values = self.lattice.get_values(
            'BPM',
            'y',
            pytac.RB,
            dtype=np.float64
        )[bpms_y_enabled]
        correctors_y_values = self.lattice.get_values(
            'VSTR',
            'a0',
            pytac.RB,
            dtype=np.float64
